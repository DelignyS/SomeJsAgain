...
const entrepreneursNames = entrepreneurs.map((entrepreneur) => {
  // Ici on peut utiliser la variable entrepreneurs car elle est déclarée en dehors de la fonction
  return {
    firstName: entrepreneur.first,
    lastName: entrepreneur.last,
    year: entrepreneur.year,
  }; // On retourne un objet avec les propriétés firstName, lastName et year
});
...
const entrepreneursNamesOnly = entrepreneursNames.map((entrepreneur) => {
  // Ici on peut utiliser la variable entrepreneursNames car elle est déclarée en dehors de la fonction
